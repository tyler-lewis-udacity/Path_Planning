        ...
        if (event == "telemetry") {
          ...
          // Main car's localization Data
            ...
            if(prev_size < 2)
            {
              ...
              double prev_car_x = car_x - cos(car_yaw); // assume hypotenuse has length 1
            ...
            /// ... so far, ptsx and ptsy have 5 points.

            for(int i=0; i<ptsx.size(); i++)
            {
              // shift car reference angle to 0 degrees (keeps projected spline near horizontal and prevents "vertical function problems")
            ...
            // fill up the rest of our planner after filling it with previous points, here we will always ouput 50 points
            for(int i=1; i<= 50-previous_path_x.size(); i++)
            {
              ...
              // rotate back to normal after rotating it earlier (local to global coordinate transformation)
